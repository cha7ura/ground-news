...
import { getBiasPercentage } from '@/lib/types';
  ...
  if (stories.length === 0) {
    return (
      <Card className="p-12 text-center">
        ...
        <h3 className="text-lg font-medium text-gray-600 mb-2">No blindspots found</h3>
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex gap-2 text-xs">
                      <span className={cn(
                        percentages.left > 0 ? 'text-bias-left' : 'text-gray-400'
                      )}>
                        L {percentages.left}%
                      </span>
                      ...
                      <span className={cn(
                        percentages.right > 0 ? 'text-bias-right' : 'text-gray-400'
                      )}>
                        R {percentages.right}%
                      </span>
                    </div>
      ...
      {[1, 2, 3].map((i) => (
        <Card key={i} className="p-4 animate-pulse">
          <div className="flex gap-4">
            ...
            <div className="flex-1">
              <div className="h-5 w-32 bg-amber-100 rounded-full mb-2" />
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">Stories with coverage gaps</p>
          </div>
        </div>
        ...
        <Card className="p-4 bg-amber-50 border-amber-200">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h2 className="font-medium text-amber-900 mb-1">What are Blindspots?</h2>
      ...
      <div className="flex gap-2 mb-6">
        ...
        <Link 
          ...
          className="px-4 py-2 text-sm font-medium bg-gray-100 text-gray-600 hover:bg-gray-200 rounded-full flex items-center gap-1"
        >
      ...
      <Card className="p-6 mt-8 bg-gradient-to-r from-amber-50 to-orange-50 border-amber-200">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-bold text-gray-900">Blindspot Report</h3>
