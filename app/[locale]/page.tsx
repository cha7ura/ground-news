  ...
  if (stories.length === 0) {
    return (
      <div className="text-center py-12 bg-white rounded-xl border border-gray-200">
        ...
        <h3 className="text-lg font-medium text-gray-600 mb-2">{dict.home.no_stories_title}</h3>
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-2">
        ...
        <h2 className="text-lg font-semibold text-gray-900">{dict.home.latest_articles}</h2>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="flex justify-center gap-6 mb-8 text-sm">
        <div className="flex items-center gap-2">
          ...
          <span className="text-gray-600">{dict.bias.left_leaning}</span>
        </div>
        <div className="flex items-center gap-2">
          <span className="w-4 h-4 rounded-full bg-bias-center" />
          <span className="text-gray-600">{dict.bias.center}</span>
        </div>
        <div className="flex items-center gap-2">
          <span className="w-4 h-4 rounded-full bg-bias-right" />
          <span className="text-gray-600">{dict.bias.right_leaning}</span>
        </div>
      </div>
      ...
      <section className="mb-12">
        <div className="flex items-center gap-2 mb-6">
          ...
          <h2 className="text-xl font-bold text-gray-900">{dict.home.top_stories}</h2>
        </div>
