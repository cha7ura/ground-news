  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-8">
        ...
        {/* Bias distribution */}
        <Card className="p-6">
          <h2 className="text-sm font-semibold text-gray-700 mb-4">{dict.story.coverage_breakdown}</h2>
      ...
      {/* Source comparison */}
      <div className="mb-8">
        <h2 className="text-xl font-bold text-gray-900 mb-6">{dict.story.compare_sources}</h2>
