      ...
      <div className="mb-8">
        <div className="flex flex-col md:flex-row md:items-start justify-between gap-4 mb-4">
          <div>
            ...
            <a 
              ...
              className="text-gray-500 hover:text-brand-primary flex items-center gap-1 mt-1"
            >
              {source.url}
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <Card className="p-4 text-center">
            <div className="text-2xl font-bold text-gray-900">{source.article_count}</div>
            <div className="text-sm text-gray-500">Articles</div>
          </Card>
          <Card className="p-4 text-center">
            <div className="text-2xl font-bold text-gray-900">{source.factuality_score}%</div>
          ...
          <Card className="p-4 text-center">
            <div className="text-2xl font-bold text-gray-900 uppercase">{source.language}</div>
        ...
        <Card className="p-4 mt-4">
          <h3 className="text-sm font-semibold text-gray-700 mb-3">Bias Position</h3>
          <div className="relative h-4 bg-gradient-to-r from-bias-left via-bias-center to-bias-right rounded-full">
            <div 
              className="absolute w-4 h-4 bg-white border-2 border-gray-800 rounded-full top-1/2 -translate-y-1/2 shadow-md"
              style={{ 
      ...
      <div>
        ...
        {articles.length === 0 ? (
          <Card className="p-12 text-center">
            ...
            <p className="text-gray-500">No articles from this source yet.</p>
          </Card>
        ) : (
