...
import { getBiasLabel, getBiasCategory } from '@/lib/types';
...
export default async function StoryPage({ params }: StoryPageProps) {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      {/* Source comparison */}
      <div className="mb-8">
        <h2 className="text-xl font-bold text-gray-900 mb-6">Compare Sources</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="font-semibold text-gray-900">
                Left-leaning ({articlesByBias.left.length})
              </h3>
            </div>
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="font-semibold text-gray-900">
                Center ({articlesByBias.center.length})
              </h3>
            </div>
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="font-semibold text-gray-900">
                Right-leaning ({articlesByBias.right.length})
              </h3>
            </div>
      ...
      {/* All articles list */}
      <div>
        <h2 className="text-xl font-bold text-gray-900 mb-6">All Articles ({articles.length})</h2>
