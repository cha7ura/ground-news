...
export default function TopicsPage() {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-3">Topics</h1>
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h2 className="font-bold text-lg text-gray-900 capitalize mb-1 group-hover:text-brand-primary transition-colors">
                  {topic}
                </h2>
      ...
      <Card className="p-6 mt-8 bg-gray-50">
        <h2 className="font-semibold text-gray-900 mb-2">How Topics Work</h2>
        <p className="text-sm text-gray-600">
