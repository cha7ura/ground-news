-- Firecrawl NUQ schema (local dev — pg_cron jobs removed, not available in postgres:16-alpine)
-- Source: https://github.com/firecrawl/firecrawl/blob/main/apps/nuq-postgres/nuq.sql
